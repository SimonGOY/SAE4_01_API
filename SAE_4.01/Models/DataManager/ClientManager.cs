...
namespace SAE_4._01.Models.DataManager
{
    public class ClientManager : IDataRepository<Client>
    {
        ...
        Task<ActionResult<Client>> IDataRepository<Client>.GetBy2CompositeKeysAsync(int id1, int id2)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Client>> IDataRepository<Client>.GetBy3CompositeKeysAsync(int id1, int id2, int id3)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Client>> IDataRepository<Client>.GetBy4CompositeKeysAsync(int id1, int id2, int id3, int id4)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Client>> IDataRepository<Client>.GetByNomAsync(string nom)
        {
            throw new NotImplementedException();
        }

        public Task<ActionResult<Client>> GetReference(int id)
        {
            throw new NotImplementedException();
        }
    }
