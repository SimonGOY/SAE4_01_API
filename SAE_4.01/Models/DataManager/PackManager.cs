...
namespace SAE_4._01.Models.DataManager
{
    public class PackManager : IDataRepository<Pack>
    {
        ...
        public async Task<ActionResult<IEnumerable<Pack>>> GetByIdMotoAsync(int id)
        {
            return await _dbContext.Packs.Where(p => p.IdMoto == id).ToListAsync();
        }
        ...
        Task<ActionResult<Pack>> IDataRepository<Pack>.GetBy2CompositeKeysAsync(int id1, int id2)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Pack>> IDataRepository<Pack>.GetBy3CompositeKeysAsync(int id1, int id2, int id3)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Pack>> IDataRepository<Pack>.GetBy4CompositeKeysAsync(int id1, int id2, int id3, int id4)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Pack>> IDataRepository<Pack>.GetByNomAsync(string nom)
        {
            throw new NotImplementedException();
        }

        public Task<ActionResult<Pack>> GetReference(int id)
        {
            throw new NotImplementedException();
        }
    }
