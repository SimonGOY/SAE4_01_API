...
namespace SAE_4._01.Models.DataManager
{
    public class AdresseManager : IDataRepository<Adresse>
    {
        ...
        Task<ActionResult<Adresse>> IDataRepository<Adresse>.GetBy2CompositeKeysAsync(int id1, int id2)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Adresse>> IDataRepository<Adresse>.GetBy3CompositeKeysAsync(int id1, int id2, int id3)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Adresse>> IDataRepository<Adresse>.GetBy4CompositeKeysAsync(int id1, int id2, int id3, int id4)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Adresse>> IDataRepository<Adresse>.GetByNomAsync(string nom)
        {
            throw new NotImplementedException();
        }

        public Task<ActionResult<Adresse>> GetReference(int id)
        {
            throw new NotImplementedException();
        }
    }
