...
namespace SAE_4._01.Models.DataManager
{
    public class CategorieCaracteristiqueManager : IDataRepository<CategorieCaracteristique>
    {
        ...
        Task<ActionResult<CategorieCaracteristique>> IDataRepository<CategorieCaracteristique>.GetByNomAsync(string nom)
        {
            throw new NotImplementedException();
        }

        public Task<ActionResult<CategorieCaracteristique>> GetReference(int id)
        {
            throw new NotImplementedException();
        }
    }
