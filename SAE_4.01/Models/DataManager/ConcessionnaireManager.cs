...
namespace SAE_4._01.Models.DataManager
{
    public class ConcessionnaireManager : IDataRepository<Concessionnaire>
    {
        ...
        Task<ActionResult<Concessionnaire>> IDataRepository<Concessionnaire>.GetByNomAsync(string nom)
        {
            throw new NotImplementedException();
        }

        public Task<ActionResult<Concessionnaire>> GetReference(int id)
        {
            throw new NotImplementedException();
        }
    }
