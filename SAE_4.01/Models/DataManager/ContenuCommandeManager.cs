...
namespace SAE_4._01.Models.DataManager
{
    public class ContenuCommandeManager : IDataRepository<ContenuCommande>
    {
        ...
        Task<ActionResult<ContenuCommande>> IDataRepository<ContenuCommande>.GetByNomAsync(string nom)
        {
            throw new NotImplementedException();
        }

        public Task<ActionResult<ContenuCommande>> GetReference(int id)
        {
            throw new NotImplementedException();
        }
    }
