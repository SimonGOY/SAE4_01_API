...
namespace SAE_4._01.Models.DataManager
{
    public class ReservationManager : IDataRepository<Reservation>
    {
        ...
        Task<ActionResult<Reservation>> IDataRepository<Reservation>.GetBy2CompositeKeysAsync(int id1, int id2)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Reservation>> IDataRepository<Reservation>.GetBy3CompositeKeysAsync(int id1, int id2, int id3)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Reservation>> IDataRepository<Reservation>.GetBy4CompositeKeysAsync(int id1, int id2, int id3, int id4)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Reservation>> IDataRepository<Reservation>.GetByNomAsync(string nom)
        {
            throw new NotImplementedException();
        }

        public Task<ActionResult<Reservation>> GetReference(int id)
        {
            throw new NotImplementedException();
        }
    }
