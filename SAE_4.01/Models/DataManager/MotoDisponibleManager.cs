...
namespace SAE_4._01.Models.DataManager
{
    public class MotoDisponibleManager : IDataRepository<MotoDisponible>
    {
        ...
        Task<ActionResult<MotoDisponible>> IDataRepository<MotoDisponible>.GetBy2CompositeKeysAsync(int id1, int id2)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<MotoDisponible>> IDataRepository<MotoDisponible>.GetBy3CompositeKeysAsync(int id1, int id2, int id3)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<MotoDisponible>> IDataRepository<MotoDisponible>.GetBy4CompositeKeysAsync(int id1, int id2, int id3, int id4)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<MotoDisponible>> IDataRepository<MotoDisponible>.GetByNomAsync(string nom)
        {
            throw new NotImplementedException();
        }

        public Task<ActionResult<MotoDisponible>> GetReference(int id)
        {
            throw new NotImplementedException();
        }
    }
