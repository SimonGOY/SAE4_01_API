...
namespace SAE_4._01.Models.DataManager
{
    public class MediaManager : IDataRepository<Media>
    {
        ...
        Task<ActionResult<Media>> IDataRepository<Media>.GetBy2CompositeKeysAsync(int id1, int id2)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Media>> IDataRepository<Media>.GetBy3CompositeKeysAsync(int id1, int id2, int id3)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Media>> IDataRepository<Media>.GetBy4CompositeKeysAsync(int id1, int id2, int id3, int id4)
        {
            throw new NotImplementedException();
        }

        Task<ActionResult<Media>> IDataRepository<Media>.GetByNomAsync(string nom)
        {
            throw new NotImplementedException();
        }
    }
